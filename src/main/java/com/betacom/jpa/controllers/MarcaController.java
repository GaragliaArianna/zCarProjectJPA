...
public class MarcaController {
	private final IMarcaServices servizio;
	...
	@PostMapping ("/create")
	public ResponseEntity<Resp> create(@RequestBody(required = true) MarcaReq req) {
		Resp r = new Resp();
		HttpStatus status = HttpStatus.OK;
		try {
			servizio.create(req);
	...
	@PutMapping ("/update")
	public ResponseEntity<Resp> update(@RequestBody(required = true) MarcaReq req) {
		Resp r = new Resp();
		HttpStatus status = HttpStatus.OK;
		try {
			servizio.update(req);
